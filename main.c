...
{   
    ...
    fflush(stdin);
    if((strcmp(s, "manager") == 0)||(strcmp(s, "Manager") == 0)||(strcmp(s,"1")==0))   
    {
      read();
    } 
    else if ((strcmp(s, "user") == 0)||(strcmp(s, "User") == 0||(strcmp(s,"2")==0))
    {
      input();
      write();
    }    
    else if ((strcmp(s, "employee") == 0)||(strcmp(s, "Employee") == 0)||(strcmp(s,"3")==0))
    {
      change(); 
